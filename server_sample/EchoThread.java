...
/**
 * A simple server thread. This class just echoes the messages sent over the socket until the socket is closed.
 * 
...
public class EchoThread extends Thread {
	 ...
	 * 
	 * @param _socket
	 *            The socket passed in from the server
	 * 
	 */
	...
	/**
	 * run() is basically the main method of a thread. This thread simply reads Message objects off of the socket.
	 * 
	 */
	public void run() {
		try {
