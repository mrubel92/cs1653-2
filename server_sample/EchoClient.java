...
/**
 * Simple client class. This class connects to an EchoServer to send text back and forth. Java message serialization is
 * used to pass Message objects around.
 * 
...
public class EchoClient {
	 ...
	 * 
	 * @param args
	 *            First argument specifies the server to connect to
	 * 
	 */
